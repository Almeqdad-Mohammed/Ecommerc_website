...
/* Functio Accept One Parameter
  This function Will Fetch All Item Of Category self

*/
  function getItem($where , $value) {
    global $con;
    $getitem = $con->prepare("SELECT * FROM items WHERE $where  = ? AND Approve = 1 ORDER BY ID DESC");
    // Execute The Code
    $getitem->execute(array($value));
    // Fetch The Item Form
    $items = $getitem->fetchAll();
    // return The Item To Used It Later
    return $items;
  }

// Function To Get  USer IF Status  Is 1 Or 0
